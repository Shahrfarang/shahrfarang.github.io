...
(function (jQuery) {
	...
	jQuery(document).ready(function() {
		...
		$('#home-slider').slick({
			...
			arrows: true,
			dots: false,
			prevArrow: '<div id="prev" class="slick-nav prev-arrow"><i></i><svg><use xlink:href="#circle"></svg></div>',
			nextArrow: '<div id="next" class="slick-nav next-arrow"><i></i><svg><use xlink:href="#circle"></svg></div>',
			responsive: [
				{
					breakpoint: 992,
					settings: {
